...
rtp_height = "";
alert('<?php
_e('Height needs to be a number', 'simple-slideshow-manager'); ?>');
}
...
rtp_width = "";
alert('<?php
_e('Width needs to be a number', 'simple-slideshow-manager'); ?>');
}
...
?>
	<div style="padding:8px;width:99%;margin-top:8px;" class="widefat">
		<table style="border:0px;" id="rtp_short_gen" cellspacing="0">
			<tr>
				<td> <?php
_e('Select Gallery', 'simple-slideshow-manager'); ?></td>
				<td>
...
?>
			...
			<tr>
				<td><?php
_e('Height', 'simple-slideshow-manager'); ?></td>
				<td>
...
_e('%', 'simple-slideshow-manager'); ?></option>
			...
			<tr>
				<td>
				<?php
_e('Width', 'simple-slideshow-manager'); ?></td><td>
...
_e('%', 'simple-slideshow-manager'); ?></option>
			...
			<tr>
				<td></td><td>	<a id="rtp_slideshow_generate_shortcode" class="manage_gallery"  href="#" style="background: none repeat scroll 0px 0px lightseagreen; color: white; padding: 0px 5px 1px; text-decoration: none; border: 1px solid gray;" alt = "Click to Manage this Gallery" onclick = "rtp_generate()"><?php
_e('Generate Shortcode', 'simple-slideshow-manager'); ?></a></td>
			</tr>
			<tr>
				<td colspan="2">
